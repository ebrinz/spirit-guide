...
- **Test the entropy effect as a function of line discontinuity directly**, rather than inferring it.
  The coherent walk already gives one point on that curve; a sweep of the coherence threshold gives
  the curve.
